 ...
 */
class CategoryUpdateApiRequest extends ApiBaseRequest
{
    /**
    ...
    {
        return [
            'name' => "required|unique:categories,name," . $this->route('id') . ",id",
            'code' => "required|unique:categories,code," . $this->route('id') . ",id"
        ];
    }
